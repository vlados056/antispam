...
SPAM_WORDS = ['требуется','занятость','сотрудник','сотрудничество','сотрудник','команду','набираем','заработка','требуются', 'напишите в лс', 'удаленно', 'прeдлoжениe o сoтрyдничeствe', 'прoeктe', 'прoeкт', 'личныe соoбщeния', 'вoзможнoсть сoвмещать', 'пишитe в личныe соoбщeния', 'сотрудничество', 'сотрудничество онлайн', 'доход', 'сотруднuчество онлайн', 'сотруднuчество', 'по всем вопросам', 'достаточно телефона']
